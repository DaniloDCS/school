...
function findCity(name) {
    name = name.toLowerCase().trim().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "");
    ...
    states.forEach(state => {
        state.cities.forEach(city => {
            if (city.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").indexOf(name) != -1)
                cities.push({
    ...
    cities.forEach(city => {
        ...
        p.innerText = JSON.stringify(city);
        document.querySelector("#cities-list").append(p);
    });
